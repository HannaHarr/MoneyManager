...
namespace MoneyManagerTest
{
    ...
    public class InitialDataTests
    {
        ...
        {
            var assetCount = InitialData
                .Assets
                .Count;
            Assert.AreEqual(
                20, assetCount);

            var asset = InitialData
                .Assets[0];
            Assert.AreEqual(
                1, asset.AssetId);
            Assert.AreEqual(
        ...
        {
            var categoryCount = InitialData
                .Categories
                .Count;
            Assert.AreEqual(
                10, categoryCount);

            var category = InitialData
                .Categories[0];
            Assert.AreEqual(
        ...
        {
            var transactionCount = InitialData
                .Transactions
                .Count;
            Assert.AreEqual(
            ...
            var transaction = InitialData
                .Transactions[0];
            Assert.AreEqual(
                1, transaction.TransactionId);
            Assert.AreEqual(
                56, transaction.Amount);
            Assert.AreEqual(
            ...
            Assert.AreEqual(
                ...
                transaction.Comment);
            Assert.AreEqual(
                1, transaction.CategoryId);
            Assert.AreEqual(
                1, transaction.AssetId);
        }
    }
}